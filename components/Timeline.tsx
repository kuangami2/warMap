...
export type TimelineProps = { currentYear: number; startYear: number; endYear: number; isPlaying: boolean; speed: 0.5 | 1 | 2 | 4; eras: Era[]; onYearChange: (year: number) => void; onToggle: () => void; onSpeed: (speed: 0.5 | 1 | 2 | 4) => void; onEra: (era: Era) => void };
...
function TimelinePrimaryAction({ isPlaying, onToggle }: Pick<TimelineProps, 'isPlaying' | 'onToggle'>) {
  const label = isPlaying ? '暂停播放' : '播放历史';
