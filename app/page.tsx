  ...
  return <main className="min-h-screen bg-stone-950 text-stone-100">
    ...
    <div className="mx-auto max-w-[1600px] p-4 md:p-7">
      ...
      <div className="mt-4 grid gap-4 xl:grid-cols-[minmax(0,1fr)_400px] 2xl:grid-cols-[minmax(0,1fr)_420px]">
        <HistoricalMap wars={visibleWars} selectedWar={selectedWar} hoveredWar={hoveredWar} onSelect={setSelectedWar} onHover={setHoveredWar} layerMode={layerMode} animations={animations} onLayerMode={setLayerMode} onAnimations={setAnimations} />
